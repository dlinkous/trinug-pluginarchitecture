...
namespace HappyStorage.UnitTests
{
    public class FacadeTests
    {
        ...
        public void CommissionsAndDecommissionsUnitsCorrectly()
        {
			...
			Assert.True(unitNumbers.Contains("2B"));
			Assert.True(unitNumbers.Contains("3C"));
			Assert.True(unitNumbers.Contains("4D"));
			Assert.True(unitNumbers.Contains("5E"));
			Assert.True(unitNumbers.Contains("6F"));
			Assert.True(unitNumbers.Contains("9I"));
		}
		...
		public void AddsAndDeletesCustomersCorrectly()
		{
			...
			Assert.True(customerNumbers.Contains("Bravo"));
			Assert.True(customerNumbers.Contains("Delta"));
			Assert.True(customerNumbers.Contains("Echo"));
			Assert.True(customerNumbers.Contains("Foxtrot"));
		}
